...
async function login(event) {
  ...
  try {
    ...
    // LOGIN HARDCODED
    // ========================
    if (nomeClube.toLowerCase() === "202401815" && password === "power123") {
    ...
    if (nomeClube.trim().toLowerCase() === "202401815" && password === "powerfun12345") {
    ...
    if (nomeClube.toLowerCase() === "202401815" && password === "12345") {
      localStorage.setItem("user_id", "funcionario");
      localStorage.setItem("username", "Funcionário");
      localStorage.setItem("role", "funcionario");
